...
|---|---|---|
| 1 | Skill customization | Complete |
| 2 | Creature customization | Complete |
...
3. Each JSON file defines one content override (e.g., a skill with modified difficulty)
...
| [[Guardrails]] | What NOT to do — API research rules |
| [[North Star]] | Design philosophy |
| [[Creature Template Decisions]] | Schema decisions for creature JSON — read before changing the `combat` block or attack structure |
