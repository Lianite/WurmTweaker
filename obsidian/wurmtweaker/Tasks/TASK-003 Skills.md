...
Define the skill JSON schema and data model. Implement `SkillHandler` that loads skill definitions and applies them via the Wurm skill API. The actual Wurm API call is a **stub** until the API is researched.
