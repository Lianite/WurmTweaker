...
tags:
  ...
  - complete
related:
  - "[[TASK-004b Creatures Java Support]]"
...
`types` (int[]) — Wurm creature type flag constants. See [[Creature Types]] for all IDs.
...
| `meatMaterial` | Byte | |
| `skills` | Map\<String,Double\> | Skill ID → base value. See [[Skill IDs]] |
| `maxAge` | Integer | |
